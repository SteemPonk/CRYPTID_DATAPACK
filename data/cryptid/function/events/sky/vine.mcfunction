...
execute as @s at @s run execute facing entity @e[sort=random, limit=1] eyes positioned ^ ^ ^80 positioned ~ 150 ~ run summon minecraft:armor_stand ~ ~ ~ {Invisible:1, NoGravity:1, Tags:["cryptid","cryptid.skyvine"],CustomName:'[{"text":"Corrupted Vine"}]'}

execute as @s at @s run execute facing entity @e[sort=random, limit=1] eyes positioned ^ ^ ^90 positioned ~ 0 ~ run summon minecraft:armor_stand ~ ~ ~ {CustomName:'[{"text":"Corrupted Spiral"}]', Invisible:1, NoGravity:1, Tags:["cryptid","cryptid.spiral","cryptid.radarignore"]}
execute as @s at @s run execute facing entity @e[sort=random, limit=1] eyes positioned ^ ^ ^90 positioned ~ 0 ~ run summon minecraft:armor_stand ~ ~ ~ {CustomName:'[{"text":"Corrupted Spiral"}]', Invisible:1, NoGravity:1, Tags:["cryptid","cryptid.spiral","cryptid.radarignore"]}
execute as @s at @s run execute facing entity @e[sort=random, limit=1] eyes positioned ^ ^ ^90 positioned ~ 0 ~ run summon minecraft:armor_stand ~ ~ ~ {CustomName:'[{"text":"Corrupted Spiral"}]', Invisible:1, NoGravity:1, Tags:["cryptid","cryptid.spiral","cryptid.radarignore"]}
execute as @s at @s run execute facing entity @e[sort=random, limit=1] eyes positioned ^ ^ ^90 positioned ~ 0 ~ run summon minecraft:armor_stand ~ ~ ~ {CustomName:'[{"text":"Corrupted Spiral"}]', Invisible:1, NoGravity:1, Tags:["cryptid","cryptid.spiral","cryptid.radarignore"]}
execute as @s at @s run execute facing entity @e[sort=random, limit=1] eyes positioned ^ ^ ^90 positioned ~ 0 ~ run summon minecraft:armor_stand ~ ~ ~ {CustomName:'[{"text":"Corrupted Spiral"}]', Invisible:1, NoGravity:1, Tags:["cryptid","cryptid.spiral","cryptid.radarignore"]}

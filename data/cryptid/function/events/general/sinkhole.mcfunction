...
execute facing entity @e[sort=random, limit=1] eyes positioned ^ ^ ^5 run summon armor_stand ~ ~20 ~ {CustomName:'[{"text":"Sinkhole"}]',Marker:1b, Invisible:1b, NoGravity:1b, Tags:["cryptid","cryptid.sinkhole","cryptid.timer"]}

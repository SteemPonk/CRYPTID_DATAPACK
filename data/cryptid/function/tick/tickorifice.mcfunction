...
execute if score @s cryptid.timer matches 100 run function cryptid:rituals/action/checkfocus
execute if score @s cryptid.timer matches 90 run function cryptid:rituals/action/checkfocus
execute if score @s cryptid.timer matches 80 run function cryptid:rituals/action/checkfocus
execute if score @s cryptid.timer matches 70 run function cryptid:rituals/action/checkfocus
execute if score @s cryptid.timer matches 60 run function cryptid:rituals/action/checkfocus
execute if score @s cryptid.timer matches 50 run function cryptid:rituals/action/checkfocus
execute if score @s cryptid.timer matches 40 run function cryptid:rituals/action/checkfocus
execute if score @s cryptid.timer matches 30 run function cryptid:rituals/action/checkfocus
